...
lda_model = gensim.models.LdaMulticore(corpus,	 num_topics=25, id2word=dictionary, passes=750, decay =0.9, gamma_threshold = 0.001)
...
#Beware that the order of topics is not keptas it was in Gensim
import pyLDAvis.gensim
lda_display = pyLDAvis.gensim.prepare(lda_model, corpus, dictionary)
pyLDAvis.display(lda_display)
pyLDAvis.save_html(lda_display, 'docs_es_25T_750p.html')
